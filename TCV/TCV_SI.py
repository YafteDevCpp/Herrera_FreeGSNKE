...
tokamak=build_machine.tokamak(
    passive_coils_path = f"{directorio_actual}/machine_configs/TCV/passive_coils.pickle",
    active_coils_path=f"{directorio_actual}/machine_configs/TCV/active_coils4.pickle",
    limiter_path=f"{directorio_actual}/machine_configs/TCV/limiter.pickle",
    wall_path=f"{directorio_actual}/machine_configs/TCV/wall.pickle",
    magnetic_probe_path=f"{directorio_actual}/machine_configs/TCV/magnetic_probes.pickle",
)

#%%

# Ruta base controlada por variable de entorno
path_resultados = os.environ.get("RESULTADOS_PATH", "./Resultados_TCVSIRM/"f"{nombre}")
